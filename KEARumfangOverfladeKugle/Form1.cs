...
namespace KEARumfangOverfladeKugle
{
    public partial class Form1 : Form
    {
        ...
        private void buttonCalc_Click(object sender, EventArgs e)
        {
            ...
            // use '(double)' in front of digits to make them a double instead of int.
            // OR write it out with comma: (double)4 or 4.0
            volume = (double)4 / 3.0 * Math.PI * Math.Pow(r, 3); // supposed formula for volume of a ball
            area = 4.0 * Math.PI * Math.Pow(r, 2); // supposed formula for area of a ball
